...
model = resnet50(pretrained=True)  # Set pretrained to False if no Pretrained
...
output_dir = 'C:\\Jason\\CRC_NRT_data\\CRC_Resnet50_pretrained_lr1e-3_batch128_cosineLR'
