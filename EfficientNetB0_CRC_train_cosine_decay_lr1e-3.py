...
model = EfficientNet.from_pretrained('efficientnet-b0') # Change the efficientnet variants here
...
output_dir = 'C:\\Jason\\CRC_NRT_data\\CRC_EfficientNetb0_lr1e-3_batch128_cosineLR'
